package com.javaman.olcudefteri.ui.reports;
...
public class ReportsActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.home:
                Intent home= new Intent(ReportsActivity.this,HomeActivity.class);
                startActivity(home);

                break;
            case R.id.orders:
                Intent orders= new Intent(ReportsActivity.this,OrdersActivity.class);
            ...
            case R.id.measure:
                ...
                break;
            case R.id.report:
                Intent report= new Intent(ReportsActivity.this,ReportsActivity.class);
