...
public class VerticalCurtain extends DialogFragment implements View.OnClickListener,CalculateView{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        etUnitPrice=view.findViewById(R.id.editTextVerticalUnitPrice);
        etTotalPrice=view.findViewById(R.id.editTextVerticalTotalPrice);

        tvTotalM2=view.findViewById(R.id.textViewVerticalM2);
